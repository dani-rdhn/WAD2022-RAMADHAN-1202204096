    ...
    <body>
        ...
        <section class="content">
            <div class="container h-100">
                <p class="main-text">{{$product->name}}</p>
                <p class="sub-text">Edit mobil {{$product->name}}</p>
                        ...
                        <form action="/product/{{$product-> id}}/edit" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row justify-content-between">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="mobil" name='mobil' value="{{$product->name}}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Nama Pemilik</label>
                                    <input class="form-control" id="nama" name='nama' value="{{$product->owner}}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Merk</label>
                                    <input class="form-control" id="merk" name='merk' value="{{$product->brand}}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Tanggal Beli</label>
                                    <input type="date" class="form-control" id="date" name="date" value="{{$product->purchase_date}}"> 
                                </div>
                                <div class="mb-3">
                                    <label class="form-label" for="textArea">Deskripsi</label>
                                    <textarea class="form-control" id="textArea" rows="5" name="deskripsi">{{$product->description}}</textarea>
                                </div>
                                <div class="mb-3">
