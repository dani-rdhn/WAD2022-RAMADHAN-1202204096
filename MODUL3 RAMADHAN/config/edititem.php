<?php
    ...
    $id = 1;
    $query = mysqli_query($connect, "SELECT * FROM showroom_ramadhan_table WHERE id = '$id'");
?>
            ...
            <div class="container h-100">
                ...
                <?php
                    ...
                    if(isset($_POST['ubah'])) {
                        ...
                        $pemilikMobil = $_POST['pemilik_mobil'];
                        $merkMobil = $_POST['merk_mobil'];
                        $date = $_POST['tanggal_beli'];
                        $deskripsi = $_POST['deskripsi'];
                        mysqli_query($connect, "UPDATE showroom_ramadhan_table set nama_mobil='$namaMobil', pemilik_mobil='$pemilikMobil', merk_mobil='$merkMobil', tanggal_beli='$date', deskripsi='$deskripsi' ");
                    }
                ?>
        </section>
    </body>
